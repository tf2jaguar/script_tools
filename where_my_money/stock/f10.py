...
def zcfzb(code: str, dates: str = '2023-03-31,2022-12-31,2022-09-30,2022-06-30,2022-03-31',
          companyType: str = 4) -> str:
    """资产负债表
...
def lrb(code: str, dates: str = '2023-03-31,2022-12-31,2022-09-30,2022-06-30,2022-03-31',
        companyType: str = '4') -> str:
    """利润表
...
# 按季度累加
# curl 'https://datacenter.eastmoney.com/securities/api/data/get?type=RPT_F10_FINANCE_GINCOME  &sty=APP_F10_GINCOME  &filter=(SECUCODE%3D%22601888.SH%22)(REPORT_DATE%20in%20(%272023-09-30%27%2C%272023-06-30%27%2C%272023-03-31%27%2C%272022-12-31%27%2C%272022-09-30%27))&p=1&ps=5&sr=-1&st=REPORT_DATE&source=HSF10&client=PC&v=05488470475912712' \
# 单季度
# curl 'https://datacenter.eastmoney.com/securities/api/data/get?type=RPT_F10_FINANCE_GINCOMEQC&sty=APP_F10_GINCOMEQC&filter=(SECUCODE%3D%22601888.SH%22)(REPORT_DATE%20in%20(%272023-09-30%27%2C%272023-06-30%27%2C%272023-03-31%27%2C%272022-12-31%27%2C%272022-09-30%27))&p=1&ps=5&sr=-1&st=REPORT_DATE&source=HSF10&client=PC&v=09579814672227527' \
